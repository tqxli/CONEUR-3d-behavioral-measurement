...
**Emerging directions in 3D human and animal tracking.** Thematically organized compilation of recent studies that illustrate a roadmap for improvements
...
| | *synthetic data* | (Doersch and Zisserman, 2019)<br /> (Wang et al., 2019) (Zhang et al., 2019)<br />  (Sengupta et al., 2020) <br />(Varol et al., 2021) | (Deane et al., 2021) <br />(Bolaños et al., 2021) | 
